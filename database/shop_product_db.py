...
def updateShopProduct(ShopProduct):
    ...
    try:
        ...
        query_tuple= (ShopProduct.shopId,ShopProduct.productId,ShopProduct.totalCommission,ShopProduct.guideCommission,ShopProduct.driverCommission,ShopProduct.companyCommissionWithGuide,ShopProduct.operatorCommission,ShopProduct.hotelRepCommission,ShopProduct.companyCommissionWithHotel,int(ShopProduct.id),ShopProduct.startDate,ShopProduct.finishDate)
        cursor.execute(query,query_tuple)
        my_db.commit()
        return True
    except Exception as e:
