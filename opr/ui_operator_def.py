...
# Form implementation generated from reading ui file 'ui_operator_def.ui'
#
...
class OperatorDefWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(574, 328)
...
"}")
        ...
        self.txt_chief_amount = QtWidgets.QLineEdit(self.frame)
        self.txt_chief_amount.setMinimumSize(QtCore.QSize(150, 0))
        self.txt_chief_amount.setToolTip("Şef Komisyon Oranı")
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(11)
        self.txt_chief_amount.setFont(font)
        self.txt_chief_amount.setStyleSheet("QLineEdit{\n"
"    background:transparent;\n"
"    border:none;\n"
"    color:white;\n"
"    border-bottom:1px solid #717072\n"
"}")
        self.txt_chief_amount.setText("")
        self.txt_chief_amount.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.txt_chief_amount.setObjectName("txt_chief_amount")
        self.verticalLayout_4.addWidget(self.txt_chief_amount)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "<strong>TRAVIS </strong> - Yeni Operatör"))
        self.txt_name.setPlaceholderText(_translate("MainWindow", "OPERATÖR ADI"))
        self.txt_chief_amount.setPlaceholderText(_translate("MainWindow", "ŞEF KOMİSYON ORANI"))
