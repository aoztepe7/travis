...
# Form implementation generated from reading ui file 'ui_guide.ui'
#
...
class GuidePanel(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("MainWindow")
        MainWindow.resize(1088, 572)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "<strong>TRAVIS </strong> - Rehberler"))
        ...
        item.setText(_translate("MainWindow", "TELEFONU"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "E-POSTA"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "REHBERLİK TÜRÜ"))
