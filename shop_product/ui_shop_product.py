...
# Form implementation generated from reading ui file 'ui_shop_product.ui'
#
...
"border-radius:10px;")
        ...
        self.frame_title.setMaximumSize(QtCore.QSize(300, 16777215))
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_title.setText(_translate("MainWindow", "<strong>TRAVIS </strong> - Mağaza Ürünleri"))
        ...
        item.setText(_translate("MainWindow", "MAĞAZA ID"))
        ...
        item.setText(_translate("MainWindow", "TOPLAM KOM ORANI"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "REHBER KOM ORANI"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "ŞOFÖR KOM ORANI"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "ŞİRKET KOM ORANI (KOKARTLI)"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "OPERATÖR KOM ORANI"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "REP KOM ORANI"))
        item = self.tableWidget.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "ŞİRKET KOM ORANI (REP)"))
        item = self.tableWidget.horizontalHeaderItem(12)
        item.setText(_translate("MainWindow", "BAŞLANGIÇ TARİHİ"))
        item = self.tableWidget.horizontalHeaderItem(13)
        item.setText(_translate("MainWindow", "BİTİŞ TARİHİ"))
